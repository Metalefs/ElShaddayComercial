...
(function (Seeder) {
    function SeedCollections() {
        ...
        var Cardapios;
        Cardapios = [];
        Cardapios.push(new MongoCollections_1.Collections.Cardapio("1", "Carne de panela", "Arroz, Feijao, Carne cozida com batata e salada", "N", "F"));
        Cardapios.push(new MongoCollections_1.Collections.Cardapio("2", "Bife de frango grelhado", "Arroz, Feijao, Macarrão ao alho e óleo, Filé de frango a milanesa", "N", "F"));
        Cardapios.push(new MongoCollections_1.Collections.Cardapio("3", "Tropeiro", "Arroz, Tropeiro com bife de porco, Couve e Torresmo", "N", "F"));
        Cardapios.push(new MongoCollections_1.Collections.Cardapio("4", "Frango com Quiabo", "Arroz, Feijao, Frango com Quiabo e Angu", "N", "F"));
        Cardapios.push(new MongoCollections_1.Collections.Cardapio("4", "Bisteca com couve e angu", "Arroz, Feijao, Bisteca com Couve e Angu", "N", "F"));
        ...
        Saladas_Complemento = [];
        Saladas_Complemento.push(new MongoCollections_1.Collections.Complemento("Alface", "S", 1.00));
        Saladas_Complemento.push(new MongoCollections_1.Collections.Complemento("Tomate", "S", 1.00));
