...
(function (service) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        console.log(msg);
                        sgMail.send(msg);
                        return [2 /*return*/, __assign(__assign({}, NovoCliente), { token: token })];
                    case 3:
                        console.log("usuário não cadastrado");
                        return [2 /*return*/, { erro: 'usuário não cadastrado' }];
                }
            });
        });
    }
    ...
    function getById(id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Mongo_1.Mongo.BuscarUm(MongoCollections_1.Collections.Cliente.NomeID, { _id: id })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    function _delete(id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Mongo_1.Mongo.Remove(MongoCollections_1.Collections.Cliente.NomeID, { _id: id })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
